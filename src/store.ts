...
import { ipc } from "./ipc";
import { DRAFT_ID, type ApprovalReq, type DataStatus, type Message, type Project, type QueuedItem, type Session, type Settings, type ToolEvent } from "./types";
...
interface Store {
  ...
  draft: { projectId: string | null; workspacePath: string | null } | null;
